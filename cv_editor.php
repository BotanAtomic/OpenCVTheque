...
$imagePath = "data/cv/$id/avatar";

if (!file_exists($imagePath)) {
    $imagePath = "layout/images/avatar.png";
}
...
<head>
    ...
    <title>OpenCvTheque - Editer un CV</title>
...
<script>
    ...
    function validateForm() {
        ...
        if (isNaN(date.getTime()) || date.getTime() > new Date().getTime()) {
            ...
            formData.push({name: "id", value: '<?php echo $cv->getId();?>'});
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data === "0") {
                        ...
                        location = "my_cv.php?update=true";
                    }
                },
                async:true
            });
